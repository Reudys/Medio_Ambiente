...
import 'package:medio_ambiente/normativas.dart';
  ...
  child: ListView(
    ...
    children: [
      DrawerHeader(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text("Menú Principal", style: TextStyle(color: Colors.white, fontSize: 22)),
          ],
        ),
      ),
       ...
       ListTile(
        ...
        title: Text("Normativas"),
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => NormativasPage()),
        ),
      ),
      ...
      ListTile(
        ...
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => ReportesActivity()),
        ),
      ),
